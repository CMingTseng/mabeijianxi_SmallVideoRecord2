...
static void put_h264_qpel8or16_hv1_lowpass_mmi(int16_t *tmp,
                                               const uint8_t *src, ptrdiff_t tmpStride,
...
static void put_h264_qpel8or16_hv2_lowpass_mmi(uint8_t *dst,
                                               int16_t *tmp, ptrdiff_t dstStride,
                                               ptrdiff_t tmpStride, int size) {
    int w = size >> 4;
    double ftmp[10];
    uint64_t tmp0;
    DECLARE_VAR_ALL64;
...
static void put_h264_qpel8or16_hv_lowpass_mmi(uint8_t *dst, int16_t *tmp,
                                              const uint8_t *src, ptrdiff_t dstStride,
                                              ptrdiff_t tmpStride,
                                              ptrdiff_t srcStride, int size) {
...
static void put_h264_qpel8_h_lowpass_l2_mmi(uint8_t *dst, const uint8_t *src,
                                            const uint8_t *src2, ptrdiff_t dstStride,
...
static void put_pixels8_l2_shift5_mmi(uint8_t *dst, int16_t *src16,
                                      const uint8_t *src8, ptrdiff_t dstStride,
                                      ptrdiff_t src8Stride, int h) {
    double ftmp[7];
    uint64_t tmp0;
    DECLARE_VAR_ALL64;
    DECLARE_VAR_ADDRT;
