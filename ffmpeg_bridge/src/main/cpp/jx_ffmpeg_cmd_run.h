...
Java_com_mabeijianxi_fmpeg_bridge_FFmpegBridge_jxCMDRun(JNIEnv *env, jclass type,
...
Java_com_mabeijianxi_fmpeg_bridge_FFmpegBridge_initJXFFmpeg(JNIEnv *env, jclass type,
        jboolean debug,
jstring logUrl_);
