...
Java_com_mabeijianxi_ffmpeg_bridge_FFmpegBridge_jxCMDRun(JNIEnv *env, jclass type,
...
Java_com_mabeijianxi_ffmpeg_bridge_FFmpegBridge_initJXFFmpeg(JNIEnv *env, jclass type,
                                                                           jboolean debug,
                                                                           jstring logUrl_) {
    JNI_DEBUG = debug;
